    ...
    <div class="mx-auto self-center">
        ...
        <div class="bg-white shadow-lg max-w-lg md:flex">
            <div class="p-4 flex-1 md:flex md:flex-col justify-center">
                <h1 class="text-2xl font-bold text-gray-800 mb-2">Modifier mon mot de passe</h1>
                <div class="mb-4">
                ...
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-green-500">Modifier mon ancien mot de passe</button>
            </div>
        </div>
        </form>
    </div>
